...
class MultiChoiceQuestionCheckBoxModel
  ...
  List<MultiChoiceCheckBoxStruct> localAnswerList = [];
  void addToLocalAnswerList(MultiChoiceCheckBoxStruct item) =>
      localAnswerList.add(item);
  void removeFromLocalAnswerList(MultiChoiceCheckBoxStruct item) =>
  ...
  void insertAtIndexInLocalAnswerList(
          int index, MultiChoiceCheckBoxStruct item) =>
      localAnswerList.insert(index, item);
  void updateLocalAnswerListAtIndex(
          int index, Function(MultiChoiceCheckBoxStruct) updateFn) =>
